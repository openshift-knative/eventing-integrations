...
@QuarkusTest
@CitrusSupport
@LocalStackContainerSupport(services = AwsService.S3, containerLifecycleListener = AwsS3SourceMockedTest.class)
public class AwsS3SourceMockedTest extends AwsS3SourceTestBase implements ContainerLifecycleListener<LocalStackContainer> {
