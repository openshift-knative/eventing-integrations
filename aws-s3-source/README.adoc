= Knative connector aws-s3-source
...
This connector uses the https://camel.apache.org/camel-kamelets/aws-s3-source.html[aws-s3-source] Kamelet that produces events for the Knative broker.
