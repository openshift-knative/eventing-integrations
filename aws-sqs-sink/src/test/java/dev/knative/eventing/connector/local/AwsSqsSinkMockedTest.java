...
import dev.knative.eventing.connector.AwsSqsSinkTestBase;
...
@QuarkusTest
@LocalStackContainerSupport(services = AwsService.SQS, containerLifecycleListener = AwsSqsSinkMockedTest.class)
public class AwsSqsSinkMockedTest extends AwsSqsSinkTestBase  implements ContainerLifecycleListener<LocalStackContainer> {
