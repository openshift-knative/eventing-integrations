...
@QuarkusTestResource(value = EventBridgeSetupResource.class, restrictToAnnotatedClass = true)
public class AwsEventBridgeSinkIntegrationTest extends AwsEventBridgeSinkTestBase {
